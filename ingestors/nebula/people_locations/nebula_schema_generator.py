#!/usr/bin/env python3
"""
Nebula Graph Schema Generator for People Locations Ontology

Converts the People Locations ontology to Nebula Graph schema definitions.
This script is part of the Nebula ingestion process for position and location tracking.
"""
...
class NebulaSchemaGenerator:
    ...
    def generate_schema(self) -> str:
        ...
        # Add header
        schema_parts.append("-- Nebula Graph Schema for People Locations Ontology")
        schema_parts.append(f"-- Generated from: {self.ontology_path}")
        schema_parts.append(f"-- Generated at: {datetime.now().isoformat()}")
        schema_parts.append("")
        
        # Add space creation
        schema_parts.append("-- Create space for People Locations data")
        schema_parts.append("CREATE SPACE people_locations_space (partition_num = 10, replica_factor = 1, vid_type = FIXED_STRING(32));")
        schema_parts.append("USE people_locations_space;")
        schema_parts.append("")
    ...
    def save_timestamped_schema(self, schema_dir: str = "schema"):
        ...
        filename = f"nebula_people_locations_schema_{timestamp}.ngql"
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate Nebula Graph schema from People Locations ontology')
    parser.add_argument('--ontology', default='../../../ontology/people_locations/people_locations_ontology.yaml', 
                       help='Path to ontology YAML file')
    parser.add_argument('--output', default='schema/nebula_people_locations_schema.ngql',
